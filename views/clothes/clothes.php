        ...
        <div class="d-flex flex-column flex-lg-row catalog">
            <section class="filter d-flex flex-column">
                ...
                <div class="d-flex flex-column mt-1 mb-3">
                    <a href="#" class="filter__category">Одежда</a>
                    <a href="/covers" class="filter__category">Чехли</a>
                    <a href="/smoke" class="filter__category">Мундштуки</a>
                    <a href="/shop" class="filter__category">Все товари</a>
                </div>
            </section>

            <div class="product-cards d-flex flex-wrap">
                <?php foreach($data as $row) : ?>
                <a href="clothes/product?id=<?=$row['id'];?>" class="product-card d-flex flex-column justify-content-between mt-2">
                    <div><img class="product-card__image target" src="/public/assets/images/<?=$row['img'];?>" alt="t-shirt"></div>
